      ...
      items: [
        {
          ...
          roles: ["SUPER_ADMIN", "ADMIN_INSTANSI", "STAFF_ASSET", "MR", "TEKNISI", "EMPLOYEE"],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          roles: ["SUPER_ADMIN", "ADMIN_INSTANSI", "STAFF_ASSET", "MR"],
        },
        {
          title: "BAST",
          url: "/bast",
          ...
          roles: ["SUPER_ADMIN", "ADMIN_INSTANSI", "STAFF_ASSET", "MR", "EMPLOYEE"],
        },
        {
          title: "Peminjaman",
          url: "/asset-loans",
      ...
      items: [
        {
          ...
          roles: ["SUPER_ADMIN", "ADMIN_INSTANSI", "STAFF_ASSET", "MR", "TEKNISI"],
        },
        {
          title: "Stock Opname",
          url: "/stock-opname",
