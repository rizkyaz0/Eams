...
- [ ] **Phase 1: Security Foundation — Auth, Registration & Typed Identity** - Fail-fast JWT secret, pinned token verification, always-EMPLOYEE registration, typed identity, deny-by-default proxy, test infrastructure
...
|-------|----------------|--------|-----------|
| 1. Security Foundation — Auth, Registration & Typed Identity | TBD | Not started | - |
